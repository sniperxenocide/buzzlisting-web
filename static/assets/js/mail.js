...
/***/ function(module, exports, __webpack_require__) {
	...
	var _workflow = __webpack_require__(1);
	...
	new _workflow2.default.WorkflowApp({
	    el: '#content',
	    data: {
	        'tableData': {},
	        'requireAuth': false,
	    ...
	    methods: {
	        generateDataTable: function generateDataTable() {
	            var _this = this;
	...
	$table.DataTable({
	    ...
	    scroller: true,
	    order: [[0, "desc"]],
	    columns: [{ "title": "Engine", "data": "engine" }, { "title": "Server", "data": "server" }, { "title": "From", "data": "account_from" }, { "title": "Connection", "data": "connection_type" }, { "title": "to", "data": "mail_to" }],
	    columnDefs: [{
	        "targets": 0,
	        "width": "15%",
	        ...
	        "targets": 1,
	        "width": "20%",
	        "render": function render(data, a, b) {
	            if (data == null) {
	                return '-';
	            } else {
	                return data + ':' + b.port;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = { WorkflowApp: WorkflowApp };
